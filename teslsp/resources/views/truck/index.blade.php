...
@section('konten')
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
                            ...
                            <!-- FORM PENCARIAN -->
                            <div class="pb-3">
                                <form class="d-flex" action="{{ url('truck') }}" method="get">
                ...
                <!-- TOMBOL TAMBAH DATA -->
                <div class="pb-3">
                  <a href='{{ url('truck/create') }}' class="btn btn-primary">+ Tambah Data</a>
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="col-md-2">Jumlah Roda Ban</th>
                            <th class="col-md-2">Luas Area Kargo 'm'</th> 
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->harga }}</td>
                            <td>{{ $item->jumlahrodaban }}</td>
                            <td>{{ $item->luasareakargo }}</td>
                            <td>
                                <a href='{{ url('truck/'.$item->id.'/edit') }}' class="btn btn-warning btn-sm">Edit</a>
                                <form onsubmit="return confirm('Yakin akan menghapus data?')" class="d-inline" action="{{ url('truck/'.$item->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
