                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="col-md-2">Luas Bagasi 'm'</th> 
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->harga }}</td>
                            <td>{{ $item->tipebahanbakar }}</td>
                            <td>{{ $item->luasbagasi }}</td>
                            <td>
                                <a href='{{ url('mobil/'.$item->id.'/edit') }}' class="btn btn-warning btn-sm">Edit</a>
                                <form onsubmit="return confirm('Yakin akan menghapus data?')" class="d-inline" action="{{ url('mobil/'.$item->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
